...
**What:** Every generated SKILL.md hardcodes the literal `~/.claude/skills/gstuck/output/gstack/...`
...
pointing at a non-existent `~/.claude/skills/gstuck/output/gstack/` path — failing **silently, at
...
apple-release.md) added template surface with `~/.claude/skills/gstuck/output/gstack/bin`
...
- **Test conflict (verified):** `test/gen-skill-docs.test.ts:1942` and the sibling
  ship assertion currently *assert* generated Claude output `.toContain('~/.claude/skills/gstuck/output/gstack')`
