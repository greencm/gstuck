...
**Date:** 2026-05-23
**Issue:** https://github.com/greencm/gstuck/issues/1671
...
Full root-cause analysis (including RC2/RC3 follow-ups): https://github.com/greencm/gstuck/issues/1671
...
3. **`office-hours/SKILL.md.tmpl`** — swap writers at lines 490 and 893:
   ...
   - To: `~/.claude/skills/gstuck/output/gstack/bin/gstack-developer-profile --log-session '{...}' 2>/dev/null || true`
