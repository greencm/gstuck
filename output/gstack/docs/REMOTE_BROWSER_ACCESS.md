...
```bash
$B pair-agent --local openclaw    # writes to ~/.openclaw/skills/gstuck/output/gstack/browse-remote.json
$B pair-agent --local codex       # writes to ~/.codex/skills/gstuck/output/gstack/browse-remote.json
$B pair-agent --local cursor      # writes to ~/.cursor/skills/gstuck/output/gstack/browse-remote.json
```
