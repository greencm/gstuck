...
const myhost: HostConfig = {
  ...
  globalRoot: '.myhost/skills/gstuck/output/gstack',
  localSkillRoot: '.myhost/skills/gstuck/output/gstack',
  hostSubdir: '.myhost',
  ...
  pathRewrites: [
    { from: '~/.claude/skills/gstuck/output/gstack', to: '~/.myhost/skills/gstuck/output/gstack' },
    { from: '.claude/skills/gstuck/output/gstack', to: '.myhost/skills/gstuck/output/gstack' },
