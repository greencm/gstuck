...
8. **Simplification** — if DIFF_LINES > 100. Read `~/.claude/skills/gstuck/output/gstack/review/specialists/simplification.md`. Advisory-only lens: hunts unrequested structure (hand-rolled stdlib, one-implementation abstractions, dependencies duplicating platform features), never coverage.
