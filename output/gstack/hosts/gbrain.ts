...
const gbrain: HostConfig = {
  ...
  globalRoot: '.gbrain/skills/gstuck/output/gstack',
  localSkillRoot: '.gbrain/skills/gstuck/output/gstack',
  hostSubdir: '.gbrain',
  usesEnvVars: true,
  ...
  pathRewrites: [
    { from: '~/.claude/skills/gstuck/output/gstack', to: '~/.gbrain/skills/gstuck/output/gstack' },
    { from: '.claude/skills/gstuck/output/gstack', to: '.gbrain/skills/gstuck/output/gstack' },
