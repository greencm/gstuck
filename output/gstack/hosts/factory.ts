...
const factory: HostConfig = {
  ...
  globalRoot: '.factory/skills/gstuck/output/gstack',
  localSkillRoot: '.factory/skills/gstuck/output/gstack',
  hostSubdir: '.factory',
  usesEnvVars: true,
  ...
  pathRewrites: [
    { from: '~/.claude/skills/gstuck/output/gstack', to: '$GSTACK_ROOT' },
    { from: '.claude/skills/gstuck/output/gstack', to: '.factory/skills/gstuck/output/gstack' },
    { from: '.claude/skills/review', to: '.factory/skills/gstuck/output/gstack/review' },
