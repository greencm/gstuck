...
const hermes: HostConfig = {
  ...
  globalRoot: '.hermes/skills/gstuck/output/gstack',
  localSkillRoot: '.hermes/skills/gstuck/output/gstack',
  hostSubdir: '.hermes',
  usesEnvVars: true,
  ...
  pathRewrites: [
    { from: '~/.claude/skills/gstuck/output/gstack', to: '~/.hermes/skills/gstuck/output/gstack' },
    { from: '.claude/skills/gstuck/output/gstack', to: '.hermes/skills/gstuck/output/gstack' },
