...
const openclaw: HostConfig = {
  ...
  globalRoot: '.openclaw/skills/gstuck/output/gstack',
  localSkillRoot: '.openclaw/skills/gstuck/output/gstack',
  hostSubdir: '.openclaw',
  usesEnvVars: true,
  ...
  pathRewrites: [
    { from: '~/.claude/skills/gstuck/output/gstack', to: '~/.openclaw/skills/gstuck/output/gstack' },
    { from: '.claude/skills/gstuck/output/gstack', to: '.openclaw/skills/gstuck/output/gstack' },
