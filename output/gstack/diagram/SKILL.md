...
```bash
~/.claude/skills/gstuck/output/gstack/bin/gstack-question-log '{"skill":"diagram","question_id":"<id>","question_summary":"<short>","category":"<approval|clarification|routing|cherry-pick|feedback-loop>","door_type":"<one-way|two-way>","options_count":N,"user_choice":"<key>","recommended":"<key>","session_id":"'"$_SESSION_ID"'"}' 2>/dev/null || true
```
...
```bash
BUNDLE=""
for c in "$HOME/.claude/skills/gstuck/output/gstack/lib/diagram-render/dist/diagram-render.html" \
