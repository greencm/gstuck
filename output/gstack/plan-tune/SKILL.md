...
7. **"Turn it off" / "disable"** → `~/.claude/skills/gstuck/output/gstack/bin/gstack-config set question_tuning false`
8. **"Turn it on" / "enable"** → `~/.claude/skills/gstuck/output/gstack/bin/gstack-config set question_tuning true`
