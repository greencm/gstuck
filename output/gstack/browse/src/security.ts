 ...
 *
 * Order:
 *  1. ~/.claude/skills/gstuck/output/gstack/bin/gstack-telemetry-log  (global install)
 *  2. .claude/skills/gstuck/output/gstack/bin/gstack-telemetry-log    (symlinked dev)
