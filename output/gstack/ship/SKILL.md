...
echo "---CONFIG---"
~/.claude/skills/gstuck/output/gstack/bin/gstack-config get skip_eng_review 2>/dev/null || echo "false"
```
...
```bash
eval $(~/.claude/skills/gstuck/output/gstack/bin/gstack-diff-scope <base> 2>/dev/null)
```
