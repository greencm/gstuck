...
export interface HostConfig {
  ...
  // --- Path Configuration ---
  /** Global install path relative to $HOME (e.g., '.config/opencode/skills/gstuck/output/gstack'). */
  globalRoot: string;
  /** Project-local skill path relative to repo root (e.g., '.opencode/skills/gstuck/output/gstack'). */
  ...
  sidecar?: {
    /** Sidecar path relative to repo root (e.g., '.agents/skills/gstuck/output/gstack'). */
    path: string;
