...
const HOST_PATHS: Record<Host, HostPaths> = {
  claude: {
    skillRoot: '~/.claude/skills/gstuck/output/gstack',
    localSkillRoot: '.claude/skills/gstuck/output/gstack',
    binDir: '~/.claude/skills/gstuck/output/gstack/bin',
    browseDir: '~/.claude/skills/gstuck/output/gstack/browse/dist',
  },
  codex: {
    skillRoot: '~/.codex/skills/gstuck/output/gstack',
    localSkillRoot: '.agents/skills/gstuck/output/gstack',
    binDir: '~/.codex/skills/gstuck/output/gstack/bin',
    browseDir: '~/.codex/skills/gstuck/output/gstack/browse/dist',
  },
};
...
**Project-scoped:**
\`\`\`bash
source <(~/.claude/skills/gstuck/output/gstack/bin/gstack-slug 2>/dev/null) && mkdir -p ~/.gstack/projects/$SLUG
\`\`\`
...
CODEX_REVIEWS_CFG=$(~/.claude/skills/gstuck/output/gstack/bin/gstack-config get codex_reviews 2>/dev/null || true)
...
\`\`\`bash
~/.claude/skills/gstuck/output/gstack/bin/gstack-config set codex_reviews enabled
\`\`\`
...
\`\`\`bash
~/.claude/skills/gstuck/output/gstack/bin/gstack-config set codex_reviews disabled
\`\`\`
...
\`\`\`bash
~/.claude/skills/gstuck/output/gstack/bin/gstack-review-log '{"skill":"codex-review","timestamp":"'"$(date -u +%Y-%m-%dT%H:%M:%SZ)"'","status":"STATUS","gate":"GATE","commit":"'"$(git rev-parse --short HEAD)"'"}'
\`\`\`
...
function processTemplate(tmplPath: string, host: Host = 'claude'): { outputPath: string; content: string } {
  ...
  if (host === 'codex') {
    ...
    content = content.replace(/\.claude\/skills\/review/g, '.agents/skills/gstuck/output/gstack/review');
