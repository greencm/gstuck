...
GSTACK_ROOT="$HOME/.codex/skills/gstuck/output/gstack"
[ -n "$_ROOT" ] && [ -d "$_ROOT/.agents/skills/gstuck/output/gstack" ] && GSTACK_ROOT="$_ROOT/.agents/skills/gstuck/output/gstack"
...
if [ "$_TEL" != "off" ] && [ -x ~/.claude/skills/gstuck/output/gstack/bin/gstack-telemetry-log ]; then
  ~/.claude/skills/gstuck/output/gstack/bin/gstack-telemetry-log \\
