 ...
 * `~/.claude/skills/gstuck/output/gstack/bin`. Bash only performs tilde expansion when the
 ...
 * Claude-style dirs are `~`-rooted (e.g. `~/.claude/skills/gstuck/output/gstack/browse/dist`)
