...
_EXT_PATH=""
_ROOT=$(git rev-parse --show-toplevel 2>/dev/null)
[ -n "$_ROOT" ] && [ -f "$_ROOT/.claude/skills/gstuck/output/gstack/extension/manifest.json" ] && _EXT_PATH="$_ROOT/.claude/skills/gstuck/output/gstack/extension"
[ -z "$_EXT_PATH" ] && [ -f "$HOME/.claude/skills/gstuck/output/gstack/extension/manifest.json" ] && _EXT_PATH="$HOME/.claude/skills/gstuck/output/gstack/extension"
