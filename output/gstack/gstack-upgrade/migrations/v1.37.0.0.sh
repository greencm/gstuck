...
#       ~/.claude/skills/gstuck/output/gstack/bin/gstack-config set local_code_index_offered true
#
...
CONFIG_BIN="$HOME/.claude/skills/gstuck/output/gstack/bin/gstack-config"
