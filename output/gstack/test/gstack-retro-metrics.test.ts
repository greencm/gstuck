...
describe('gstack-retro-metrics contract', () => {
  ...
  test('the skill fence invokes the script with primary path + degraded fallback', () => {
    ...
    expect(tmpl).toContain('$HOME/.claude/skills/gstuck/output/gstack/bin/gstack-retro-metrics');
    expect(tmpl).toContain('".claude/skills/gstuck/output/gstack/bin/gstack-retro-metrics"');
