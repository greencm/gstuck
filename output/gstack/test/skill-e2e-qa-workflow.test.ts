...
qa is a carved skill: when SKILL.md tells you to Read ~/.claude/skills/gstuck/output/gstack/qa/sections/<file>, read qa/sections/<file> in this working directory instead (same content, local copy).
