...
- Replace any ~/.claude/skills/gstuck/output/gstack/bin/ references with ./bin/ (relative path).
- Replace any ~/.claude/skills/gstuck/output/gstack/scripts/ references with ./scripts/.
