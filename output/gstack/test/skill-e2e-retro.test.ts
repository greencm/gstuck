...
function buildRetroFixture(dir: string): void {
  ...
  // (~/.claude/skills/gstuck/output/gstack/retro/sections/...), which doesn't exist under
  ...
  // $HOME/.claude/skills/gstuck/output/gstack/bin first (absent in the hermetic HOME), then
  // the cwd-relative .claude/skills/gstuck/output/gstack/bin fallback — satisfy the fallback
