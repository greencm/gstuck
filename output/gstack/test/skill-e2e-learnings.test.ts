...
- The bin scripts are at ./bin/ (relative to this directory), not at ~/.claude/skills/gstuck/output/gstack/bin/.
  Replace any references to ~/.claude/skills/gstuck/output/gstack/bin/ with ./bin/ when running commands.
- Replace any references to ~/.claude/skills/gstuck/output/gstack/bin/gstack-slug with ./bin/gstack-slug.
