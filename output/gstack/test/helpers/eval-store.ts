...
export function getProjectEvalDir(): string {
  try {
    ...
    const localSlug = spawnSync('bash', ['-c', '.claude/skills/gstuck/output/gstack/bin/gstack-slug 2>/dev/null || ~/.claude/skills/gstuck/output/gstack/bin/gstack-slug 2>/dev/null'], {
