...
Report whether it worked.`,
  ...
  testConcurrentIfSelected('skillmd-no-local-binary', async () => {
    // Create a tmpdir with no browse binary — no local .claude/skills/gstuck/output/gstack/browse/dist/browse
...
Report the exact output. Do NOT try to fix or install anything — just report what you see.`,
    ...
    // ~/.claude/skills/gstuck/output/gstack/browse/dist/browse exists, so we get READY.
