 ...
 *   └── .claude/skills/gstuck/output/gstack/
 ...
 *                             `$HOME/.claude/skills/gstuck/output/gstack/bin/gstack-skill-start`
...
describeE2E('Spawned docsync JSON contract E2E (gate)', () => {
  describeIfSelected('Spawned docsync JSON contract', ['docsync-spawned'], () => {
    ...
    beforeAll(() => {
      ...
      // $HOME/.claude/skills/gstuck/output/gstack/bin/gstack-skill-start here ($0-relative
