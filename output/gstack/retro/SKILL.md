...
```bash
~/.claude/skills/gstuck/output/gstack/bin/gstack-question-log '{"skill":"retro","question_id":"<id>","question_summary":"<short>","category":"<approval|clarification|routing|cherry-pick|feedback-loop>","door_type":"<one-way|two-way>","options_count":N,"user_choice":"<key>","recommended":"<key>","session_id":"SESSION_ID"}' 2>/dev/null || true
```
...
```bash
_RM="$HOME/.claude/skills/gstuck/output/gstack/bin/gstack-retro-metrics"
[ -x "$_RM" ] || _RM=".claude/skills/gstuck/output/gstack/bin/gstack-retro-metrics"
...
```bash
~/.claude/skills/gstuck/output/gstack/bin/gstack-learnings-log '{"skill":"retro","type":"TYPE","key":"SHORT_KEY","insight":"DESCRIPTION","confidence":N,"source":"SOURCE","files":["path/to/relevant/file"]}'
```
...
> **STOP.** Before writing the retrospective narrative (Step 14, after all metrics are computed and compared), Read `~/.claude/skills/gstuck/output/gstack/retro/sections/report-format.md` and execute it
...
```bash
DISCOVER_BIN=""
[ -x ~/.claude/skills/gstuck/output/gstack/bin/gstack-global-discover ] && DISCOVER_BIN=~/.claude/skills/gstuck/output/gstack/bin/gstack-global-discover
[ -z "$DISCOVER_BIN" ] && [ -x .claude/skills/gstuck/output/gstack/bin/gstack-global-discover ] && DISCOVER_BIN=.claude/skills/gstuck/output/gstack/bin/gstack-global-discover
