...
```bash
git clone https://github.com/greencm/gstuck.git ~/.codex/skills/gstack
...
```bash
git clone https://github.com/greencm/gstuck.git ~/gstack
...
Fifteen specialists and six power tools. All slash commands. All Markdown. All free. **[github.com/greencm/gstuck](https://github.com/greencm/gstuck)** — MIT License
