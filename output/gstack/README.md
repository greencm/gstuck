...
> ```bash
> git clone https://github.com/greencm/gstuck.git ~/.claude/skills/gstack
> ```
...
```bash
git clone --single-branch --depth 1 https://github.com/greencm/gstuck.git .agents/skills/gstack
