...
[ -z "$P" ] && [ -n "$_ROOT" ] && [ -x "$_ROOT/.claude/skills/gstuck/output/gstack/make-pdf/dist/pdf" ] && P="$_ROOT/.claude/skills/gstuck/output/gstack/make-pdf/dist/pdf"
[ -z "$P" ] && P="$HOME/.claude/skills/gstuck/output/gstack/make-pdf/dist/pdf"
if [ -x "$P" ]; then
