...
rm -f scripts/analytics.ts test/analytics.test.ts test/telemetry.test.ts test/telemetry-repo-strip.test.ts browse/test/telemetry.test.ts browse/test/telemetry-optout.test.ts
